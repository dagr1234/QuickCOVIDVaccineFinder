...
public struct Colors {
    public static let SpecialBlue:Color = Color(hexString: "#ACDDDE")
    public static let SpecialAeroBlue:Color = Color(hexString: "#CAF1DE")
    public static let SpecialNyanza:Color = Color(hexString: "#E1F8DC")
